...
- Recent studies use whole genome sequencing, so we can use many more genes (e.g. core genome MLST with 1343 genes).
...
- But just picking 7 genes at random gives the same answer!
]
